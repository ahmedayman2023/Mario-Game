...
export default function UserNotRegisteredError() {
  return (
    <div className="fixed inset-0 flex items-center justify-center mario-sky p-4">
      <div className="max-w-md w-full bg-panel mario-block p-8 text-center">
        <div className="w-16 h-16 bg-mario-red mario-block-sm rounded-full flex items-center justify-center mx-auto mb-6">
          <AlertCircle size={32} className="text-white" />
        </div>
        <h2 className="text-xl font-black text-white mb-2 scoreboard-font uppercase tracking-wide">لم يتم العثور على الحساب</h2>
        <p className="text-white/60 mb-8 font-bold text-sm">
